...
export function addLayers(map, swipemap, parts, tilesets, layerAdder, borderId) {
    ...
    if (["ca_alturas", "austin", "batonrouge", "chicago", "fortworth", "lowell", "ontarioca", "philadelphia", "phoenix", "providence_ri", "rochestermn", "santa_clara", "napa", "napaschools", "portlandor", "kingcountywa", "miamifl", "ccsanitation2", "vabeach",
