...
function datasetInfo(state) {
    ...
    if (acsLocations.includes(place.id.toLowerCase()) || state.units.id.includes("2019") || population.name !== "Population") {
        ...
        [
            ...
            "belmontredwood", "haywardhard", "lagunaniguel", "lagunaniguel2", "drycreek", "losaltos", "foster",
        ].includes(place.id)
    ) {
    ...
    } else if (["ca_watsonville", "ca_rohnert", "ca_brentwood", "actransit"].includes(place.id)) {
