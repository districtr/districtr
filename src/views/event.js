...
<p>To learn more about the County’s redistricting effort, visit \
 <a href='https://www.saccounty.net' target='_blank'>www.saccounty.net</a>.</p>",
  ...
  santarosa:'<p>Every ten years, local governments use new United States Census data to redraw their district lines to reflect how local populations have changed. This process, called redistricting, is important in ensuring that each City Council Member represents substantially the same number of constituents. How those lines are drawn affects how people are represented.</p>\
  ...
  <p><strong>You can also submit your own plan for how to divide the city into seven districts</strong>. Every plan submitted to the City will be carefully reviewed and included as part of the public record. For more information, <a href="https://srcity.org/2593/District-Based-Elections" target="_blank">visit this link.</a></p>\
