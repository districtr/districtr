...
const eventDescriptions = {
  ...
  "unca-forsyth":
    'Welcome to your class page UNC Asheville students! We\'re excited for you to start exploring Forsyth County with Districtr. <a href="/guide">Click here</a> for a tutorial.',
  buncombe: "Welcome to the event page for Buncombe County!",
  "common cause md ss":
    "Welcome to the event page for the Common Cause Maryland project!",
  "commoncause md ss":
    "Welcome to the event page for the Common Cause Maryland project!",
  "cc-md-ss":
    "Welcome to the event page for the Common Cause Maryland project!",
  "cc md ss":
    "Welcome to the event page for the Common Cause Maryland project!",
  "cc-nm-abq":
    "Welcome to the event page for the Common Cause New Mexico project!",
  centralsan:
    'Welcome to the event page for the Central Contra Costa County Sanitary District. This page uses Districtr, a community web tool provided by the MGGG Redistricting Lab. <a href="/guide">Click here</a> for a Districtr tutorial.',
  ...
  "pmc-districts":
    "<p>Welcome to the PMC-Districts event page for the People’s Maps Commission (PMC) of Wisconsin. The Commission is a group of people that will hear directly from folks across the state and draw fair, impartial maps for the Legislature to take up in 2021. Click <a href='https://govstatus.egov.com/peoplesmaps' target='_blank'>here</a> to learn more about their work.</p>\
  ...
  powercoalition:
    'Welcome to the greater Baton Rouge event page for the <a href="https://powercoalition.org/">Power Coalition</a>. This page is set up to let you identify your communities of interest.<br/><br/>Show us the important places and tell us the stories that you want the mapmakers to see when they draw the lines!',
  "open-maps":
    "<p>Welcome to the public mapping page for OPEN Maps!</p>\
  ...
  "missouri-mapping":
    "<p>You can help us map Missouri! When you click “Save” to share your map, <strong>enter the tag “missouri-mapping”</strong> to post your map on this public submission page. You can also enter it along with written comments at <a href='https://research.typeform.com/to/zH14rNfF' target='_blank'>our portal</a>.</p>",
  ourmapsmn:
    "<p>Welcome to the Our Maps Minnesota Redistricting Campaign Mapping page! The Our Maps MN Campaign is committed to a community-focused, accessible, and transparent redistricting process in Minnesota. Through this campaign we aim to:</p>\
...
<p>Visit <a href='http://www.reno.gov/Redistricting' target='_blank'>Reno.Gov/Redistricting</a> for more detailed instructions on how to use this tool.</p>\
<p>Thank you for sharing your input!</p>\
<p>La Ciudad de Reno pasara de cinco a seis distritos como resultado de la legislación estatal promulgada durante la sesión legislativa estatal de 2017. La Ciudad debe seguir las leyes federales y estatales y utilizar los principios adoptados por el Concejo Municipal para la redistribución de distritos. Los distritos deben tener casi la misma población con una desviación total permitida de hasta el 5 por ciento. Consulte <a href='http://www.reno.gov/Redistricting' target='_blank'>Reno.Gov/Redistricting</a> para obtener más información sobre los requisitos que se deben seguir.</p>\
<p>¡Necesitamos su ayuda para construir los mapas con los nuevos límites de cada distrito! Utilice esta herramienta para enviar sus comentarios y opiniones. Puede dibujar mapas para los distritos o identificar los límites de su comunidad, conocida como comunidad de interés (COI por sus siglas en inglés). Cada mapa presentado será revisado e incluido como parte del registro público</p>\
<p>Comience haciendo clic en uno de los botones a continuación. Para compartir y guardar su mapa, haga clic en \"Save\" en la esquina superior derecha del módulo de mapas. Para fijar su mapa a esta página, asegúrese de usar la etiqueta \"#Reno2023\". Visite <a href='http://www.reno.gov/Redistricting' target='_blank'>Reno.Gov/Redistricting</a> para obtener instrucciones más detalladas sobre cómo usar esta herramienta.</p>\
<p>¡Gracias por compartir tu opinión!</p>",
  jeffco2023:
    "<p>Redistricting is the process of drawing lines for districts from which public officials are elected. When done correctly (and fairly) the districts will accurately reflect population changes, racial diversity, communities of interest, and provide an equal voice to all county residents.</p>\
  ...
  miami2023:
    "<p>Every ten years, as the population of Miami changes, new census data is used to redraw Miami commission district boundaries. This process, called redistricting, is important to ensure each Commissioner represents about the same number of constituents. Redistricting also determines which neighborhoods and communities are grouped together into a district for the purpose of electing a City Commissioner.</p>\
...
<p>This website can be an aid to help us all understand our communities and determine the boundaries that we’ll use for our representation in city government. Right now, Miami has five separate districts, and each is represented on the City Commission by a single commissioner. Each district commissioner has a vote in city laws.</p>\
...
<p>Two tools are presented below. One tool creates a map using five districts. You can draw those districts wherever you want and save the results. Use the purple button to start.</p>\
<p>The second tool is used to identify communities of interest. Since you know your community best, you can use this tool to identify those places and areas that make up your personal community. Taken together these personal communities can inform planners on how to best understand Miami. Get started by clicking the red button.</p>\
<p>To share your map, click “Save” in the upper right corner of the mapping module. If you give your map a name, please <strong>do not use your name</strong>, so as to preserve your privacy. If you choose, you can copy your map’s url and send it to <a target='_blank' href='mailto:grovevoters@gmail.com'>grovevoters@gmail.com</a> with your comments about the map. You can create multiple maps or save maps in draft form before they are displayed.</p>",
  mesaaz:
    "<p>Every 10 years, Mesans get the chance to help reshape their City Council districts following the decennial U.S. Census. It’s important to know about the communities of Mesa so that the district lines can amplify the voices of residents.</p>\
  ...
  slo_county:
    "<p>Every 10 years, Californians get the chance to help reshape their Supervisor Board districts following the decennial U.S. Census. It’s important to know about communities so that the district lines can amplify the voices of residents.</p>\
  ...
  onelovemi:
    "<p>Welcome to the event page for One Love Michigan! Here is a message from the organization:</p>\
  ...
  saccounty:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Sacramento County’s 2021 supervisorial redistricting.<p>\
...
<p>To learn more about the County’s redistricting effort, visit \
  ...
  fresno:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Fresno County’s 2021 supervisorial redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  nevadaco:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Nevada County’s 2021 supervisorial redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  sanmateoco:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for San Mateo County’s 2021 supervisorial redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  sanbenito:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for San Benito County’s 2021 supervisorial redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  sonomaco:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Sonoma County’s 2021 supervisorial redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  pasadena2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Pasadena's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  ...
  sunnyvale2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Sunnyvale's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  laverne:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for La Verne's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  pomonaca:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Ponoma's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  richmondca:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Richmond's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  elcajon:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for El Cajon's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  carlsbad2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Carlsbad's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  encinitas2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Encinitas's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  bp2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Buena Park's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  hmb2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Half Moon Bay's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  stockton2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Stockton's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  lodi2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Lodi's 2021 city council redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  glendale2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Glendale's 2021 city council redistricting.<p>\
   <p>To let the City know about your community and what brings it together, \
share your map and your story using this tool now.</p>\
   <p><strong>To display your map on this page, be sure the tag &quot;Glendale2021&quot; is filled \
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  marinco:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Marin County's 2021 supervisorial redistricting.<p>\
   <p>As part of the redistricting process, the California FAIR MAPS Act includes \
   neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
   population that shares common social or economic interests that should \
   be included within a single district for purposes of its effective and fair \
...
<p>To learn more about the County’s redistricting effort, visit \
 <a href='https://www.saccounty.net' target='_blank'>www.saccounty.net</a>.</p>",
  ...
  napa_boe:
    "<p>Every 10 years, Californians get the chance to help reshape the seven Napa County Board of Education districts based on current United States Census data. Redistricting is based on population and communities of interest. A community of interest shares common social and economic interests that should be included within a single supervisor district to achieve effective and fair representation for its residents.</p> \
    <p>Examples of communities can include neighborhoods, areas where many residents speak the same language, areas using the same community facilities such as schools, transportation and public services.  It’s basically any geographic area where people have a common interest that needs a voice in government.</p>\
  ...
  city_of_napa:
    "<p>Every 10 years, Californians get the chance to help reshape their City Council districts following the decennial U.S. Census. It’s important to know about communities so that the district lines can amplify the voices of residents.</p>\
...
<p>Examples of communities can include cities, neighborhood associations or planning zones, areas where many residents speak the same language, or even areas where the residents use the same community facilities. It’s basically any part where people have a common interest that needs a voice in government.</p>\
  ...
  santa_clara_county:
    '<p>Every 10 years, Californians get the chance to help reshape their Supervisor districts following the decennial U.S. Census. It’s important to know about communities so that the district lines can amplify the voices of residents.</p>\
<p>Examples of communities can include cities, neighborhood associations or planning zones, areas where many residents speak the same language, or even areas where the residents use the same community facilities. It’s basically any part where people have a common interest that needs a voice in government.</p>\
     <p><strong>We need your help to build a community map! Please use this tool to identify the boundaries of your community and share what makes it a community.</strong></p>\
...
<p>Examples of communities can include cities, neighborhood associations or planning zones, areas where many residents speak the same language, or even areas where the residents use the same community facilities. It’s basically any part where people have a common interest that needs a voice in government.</p>\
 ...
 <p>Examples of communities can include cities, neighborhood associations or planning zones, areas where many residents speak the same language, or even areas where the residents use the same community facilities. It’s basically any part where people have a common interest that needs a voice in government.</p>\
  ...
  san_mateo_city:
    '<p>The City of San Mateo is in the process of moving from an at-large election system to a by-district election system. To draw these new districts we need to hear from you as it’s important to know about your community so that the district lines can amplify the voices of residents. Learn more on the <a href="https://www.cityofsanmateo.org/4537/District-Elections">Represent San Mateo web page</a>.</p>\
...
<p>Examples of communities can include cities, neighborhood associations or planning zones, areas where many residents speak the same language, or even areas where the residents use the same community facilities. It’s basically any part where people have a common interest that needs a voice in government.</p>\
  ...
  <p>For a detailed how-to guide of Districtr, visit our <a href="/guide" target="_blank">Guide page</a>.</p>',
  foothilldeanza:
    '<p>For the first time since its founding in 1957, the Foothill-De Anza Community College District is changing the way it elects members of its Board of Trustees. The district will move from an at-large election system, where voting takes place districtwide, to having voters in each of five trustee areas elect a member to serve on the governing board.</p>\
  ...
  marinaca:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Marina's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  fresnocity:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Fresno's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  arroyog:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Arroyo Grande's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  chulavista:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Chula Vista's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  camarillo:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Camarillo's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  yumasup:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Yuma County's 2021 supervisorial redistricting.<p>\
     <p>To let the County know about your community and what brings it together, \
  share your map and your story using this tool now.</p>\
     <p><strong>To display your map on this page, be sure the tag &quot;YumaSup&quot; is filled \
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  yumaawc:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Arizona Western College's 2021 trustee board redistricting.<p>\
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  bellflower:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Bellflower's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  goleta:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Goleta's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  sbcounty:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Santa Barbara's 2021 county supervisorial redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  kingsco:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Kings County's 2021 supervisorial redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  mercedco:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Merced County's 2021 supervisorial redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  lakee:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Lake Elsinore's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  chino2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Chino's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  campbellcity:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Campbell's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  buellton:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Buellton's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  vallejo:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Vallejo's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  groverbeach:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Grover Beach's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  fremont2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Fremont's 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
  ...
  commoncausepa:
    "<p>Welcome to the Community Mapping page managed by Common Cause PA.<p>\
  ...
  "ft-myers":
    "<p>Welcome to The City of Fort Myers Online Redistricting Project.<p>\
  ...
  glendora2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Glendora's 2021 city council redistricting.<p>\
  ...
  `,
  poway2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Poway County’s 2021 city council redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
...
out after you've clicked &quot;Save&quot; to share the map.</strong></p>",
  torrance2021:
    "<p>Welcome to the Districtr Community of Interest public mapping tool for Torrance County’s 2021 city counci redistricting.<p>\
     <p>As part of the redistricting process, the California FAIR MAPS Act includes \
     neighborhoods and “Communities of Interest” as important considerations. California law defines Communities of Interest as “a \
     population that shares common social or economic interests that should \
     be included within a single district for purposes of its effective and fair \
...
circular or rectangular, and not snaking lines or ribbons</li>
  ...
  healdsburg: `<p>The City of Healdsburg is in the process of moving from an at-large election system to a
by-district election system. To draw these new election districts for the
City Council, we need to hear from you! It’s important the City knows
about your community as the lines are being drawn, so the city council
district lines can amplify the voices of residents.
Learn more on <a href="https://healdsburg.gov/1152/Transition-to-District-Elections">our website.</a></p>
<p>Examples of communities can include neighborhoods, areas where many
residents speak the same language, or areas where the residents use the
same public facilities.</p>
<p>We need your help to build a community map and our new by-election
...
It’s important the District knows about your community as
the lines are being drawn, so the election district lines can
amplify the voices of residents. Learn more on <a href="https://www.losaltosca.gov/cityclerk/page/district-based-elections" target="_blank">our website</a>.
</p>
<p>Examples of communities can include neighborhoods, areas
where many residents speak the same language, or areas
where the residents use the same school facilities.</p>
<p>We need your help to build a community map and our new
by-election district map! Please use this tool to identify the
boundaries of your community and provide draft election
district maps.</p>
<p>Every map submitted will be carefully reviewed by
professional demographers, staff and the current city council
members, who are in charge of drawing the boundary map.</p>
<p>Get started by clicking the orange or purple button to draw
your community of interest or a districted map. To share your
map, click “Save” in the upper right corner of the mapping
module, select “Share Now,” and then click on the “Share to
Gallery” button. A “Team” or “Plan” name is encouraged but
optional.</p>
<p><u>Each by-district map must follow this set of ranked Districting
Criteria</u>:
<ul>
<li>Relatively equal in size – total deviation is under 10%</li>
<li>Contiguous – election districts are one whole piece and
don’t jump from one area of the district to another with
gaps in between</li>
<li>Maintain “communities of interest”</li>
<li>Easily identifiable and understandable lines, following
city, natural (rivers, mountains), and man-made
boundaries (main thoroughfares, highways)</li>
<li>Keep election districts compact – election districts should
be more circular or rectangular, and not snaking lines or
ribbons</li>
</ul></p>`,
  ...
  if (validEventCodes[eventCode]) {
    ...
    if (coi_events.includes(eventCode)) {
      ...
      document.getElementById("introExplain").innerHTML =
        "Draw a Map #RedrawNapa<br/>";
      document.getElementById("eventHeadline").innerText = "City_of_Napa";
      document.getElementById("communities").innerText =
        "Start Drawing a Map or Your Community of Interest!";
    } else if (eventCode === "cityofdallas") {
      document.getElementById("introExplain").innerHTML = "";
      document.getElementById("eventHeadline").innerText =
        "Welcome to the Public Mapping Page for the City of Dallas TX";
      ...
      document.getElementById("districting-options-title").innerHTML =
        "<p>Click below to start with a blank map. Please note that zooming into the map will allow you to see various points of interest and street names in greater detail.</p>";
    }
    ...
    if (["mp-maps"].includes(eventCode)) {
      document.getElementById("eventHeadline").innerText = og_eventCode;
      document.getElementById("introExplain").innerText =
        "City of Menlo Park Redistricting";
      document.getElementById("introExplain").style.display = "block";
    }
    ...
    if (["commoncausepa"].includes(eventCode)) {
      ...
      document.getElementById("partner-link-a").href =
        "https://www.commoncause.org/pennsylvania/";
      document.getElementById("partnership-a").src =
        "/assets/CC_Share_PA.png?v=2";
      document.getElementById("partner-link-b").href =
        "https://www.commoncause.org/";
      document.getElementById("partnership-b").src =
        "/assets/commoncauselogo.png?v=2";
    }
    ...
    if (["rohnert_park"].includes(eventCode)) {
      document.getElementById("partnership-icons").style.display = "block";
      document.getElementById("partner-link-a").href =
        "https://www.rpcity.org/";
      document.getElementById("partnership-a").src =
        "/assets/partners-rohnert-park.jpeg";
      document.getElementById("partnership-a").style.marginRight = 0;
      document.getElementById("partnership-b").style.display = "none";
    }
    if (["brentwood"].includes(eventCode)) {
      document.getElementById("partnership-icons").style.display = "block";
      document.getElementById("partner-link-a").href =
        "https://www.brentwoodca.gov/default.asp";
      document.getElementById("partnership-a").src =
        "/assets/partners-brentwood.png";
      document.getElementById("partnership-a").style.marginRight = 0;
      document.getElementById("partnership-b").style.display = "none";
    }
    if (["watsonville"].includes(eventCode)) {
      ...
      document.getElementById("partnership-a").src =
        "/assets/partners-watsonville.png";
      document.getElementById("partnership-a").style.marginRight = 0;
      document.getElementById("partnership-b").style.display = "none";
    }
    if (["millbrae"].includes(eventCode)) {
      document.getElementById("partnership-icons").style.display = "block";
      document.getElementById("partner-link-a").href =
        "https://www.configuremillbrae.org/";
      document.getElementById("partnership-a").src =
        "/assets/partners-millbrae.jpeg";
      document.getElementById("partnership-a").style.marginRight = 0;
      document.getElementById("partnership-b").style.display = "none";
    }
    ...
    if (["draweg"].includes(eventCode)) {
      document.getElementById("partnership-icons").style.display = "block";
      document.getElementById("partner-link-a").href =
        "http://www.elkgrovecity.org/city_hall/city_government/city_council/redistricting";
      document.getElementById("partnership-a").src =
        "/assets/partners-draweg.jpg";
      document.getElementById("partnership-a").style.marginRight = 0;
      document.getElementById("partnership-b").style.display = "none";
    }
    ...
    if (
      ...
      if (eventCode == "yubacity") {
        ...
        document.getElementById("partnership-a").src =
          "/assets/partners-lodi.png?v=2";
        document.getElementById("partnership-a").style.background = "#000";
      } else if (eventCode === "glendora2021") {
        document.getElementById("partner-link-a").href =
          "https://drawglendora.org/";
        document.getElementById("partnership-a").src =
          "/assets/partners-glendora.png?v=2";
      } else if (eventCode === "torrance2021") {
        document.getElementById("partner-link-a").href =
          "https://www.torranceca.gov";
        document.getElementById("partnership-a").src =
          "/assets/partners-torrance.png";
        document.getElementById("partnership-a").style.background = "#888";
      } else if (eventCode === "poway2021") {
        document.getElementById("partner-link-a").href =
          "https://www.poway.org";
        document.getElementById("partnership-a").src =
          "/assets/partners-poway.png";
        document.getElementById("partnership-a").style.background = "#000";
      } else {
        document.getElementById("partner-link-a").href =
          "https://www.saccounty.net/Redistricting/Pages/default.aspx";
        document.getElementById("partnership-a").src =
          "/assets/partners-sacramento.png?v=2";
      }
    } else if (["cityofdallas"].includes(eventCode)) {
      document.getElementById("partnership-icons").style.display = "block";
      document.getElementById("partnership-b").src =
        "/assets/partners-arcbridge.jpeg";
      document.getElementById("partner-link-b").href =
        "https://www.arcbridge.com";
      document.getElementById("partner-link-a").href =
        "https://dallascityhall.com";
      document.getElementById("partnership-a").src =
        "/assets/partners-dallas.png";
    }
    ...
    if (longAbout[eventCode]) {
      ...
      document.getElementsByClassName("about-section")[0].style.display =
        "list-item";
      document.getElementById("about-section-text").innerHTML = longAbout[
        eventCode
      ]
        .map((p) => "<p>" + p + "</p>")
        .join("");
    ...
    if (eventCode === "ttt") {
      ...
      render(
        html`<text class="italic-note"
          >This is a training page for using Districtr to draw districts and map
          communities. You can start in any state and use the tag "TTT" to post
          here.</text
        >`,
        title,
      );
      ...
      render(
        until(
          PlaceMapWithData((tgt) => toStateCommunities(tgt, "ttt")),
          "",
        ),
        map_section,
      );
    ...
    if (eventCode === "open-maps") {
      ...
      document.getElementById("districting-options-title").style.display =
        "none";
      const scale = 3200;
      const translate = [-440, 240];
      const path = geoPath(
        geoAlbersUsaTerritories().scale(scale).translate(translate),
      ).pointRadius(9);
      fetch("/assets/oh-zone-map.geojson")
        .then((res) => res.json())
        .then((gj) => {
          render(
            svg`<svg viewBox="0 0 300 300" style="width:300px; height:300px;">
                  ...
                  .map((feature, idx) => {
                    return svg`<path id="x" stroke="#fff" stroke-width="2" stroke-linejoin="round" stroke-linecap="round"
                        ...
                        @click=${(e) => {
                          document
                            .querySelector(
                              ".pcommunity." + feature.properties.name,
                            )
                            .click();
                        }}></path>`;
                  })}
                  ...
                  ${gj.features
                    ...
                    .map((feature, idx) => {
                      return svg`<path class="circle"
                          ...
                          @click=${(e) => {
                            document
                              .querySelectorAll(".pcommunity")
                              .forEach((block) => {
                                let city = block.innerText
                                  .trim()
                                  .split("\n")[0]
                                  .toLowerCase();
                                if (
    ...
    if (document.getElementById("draw-goal")) {
      if (hybrid_events.includes(eventCode)) {
        ...
        document.getElementById("draw-goal").innerText = coi_events.includes(
          eventCode,
        )
      ...
      validEventCodes[eventCode].forEach((placeID) => {
        ...
        if (unitTypes[eventCode]) {
          if (unitTypes[eventCode].no) {
            // block-list
            place.units = place.units.filter(
              (u) => !unitTypes[eventCode].no.includes(u.name),
            );
          } else if (unitTypes[eventCode].yes) {
            // allow-list
            place.units = place.units.filter((u) =>
              unitTypes[eventCode].yes.includes(u.name),
            );
          }
        }
        ...
        until(
          render(
            placeItems(
              ...
              startNewPlan,
              eventCode,
              portal_events.includes(eventCode),
            ),
            mydiv,
          ),
          "Loading...",
                ...
                districtingProblems: [
                  {
                    ...
                    custom_intro:
                      eventCode === "mapsofla" ? "Draw your community" : "",
                  },
                ],
              },
              startNewPlan,
    ...
    let showPlans = (data, drafts = false) => {
      ...
      drafts
        ? (prevDrafts = prevDrafts.concat(
            data.plans.filter(
              (p) => !(blockPlans[eventCode] || []).includes(p.simple_id),
            ),
          ))
        : (prevPlans = prevPlans.concat(
            data.plans.filter(
              (p) => !(blockPlans[eventCode] || []).includes(p.simple_id),
            ),
          ));
      const plans = [
        {
          title:
            eventCode === "missouri-mapping"
              ? "What community maps can look like"
              : drafts
                ? "Works in Progress"
                : "Public Gallery",
              ...
              ? html`<button
                    ...
                    @click="${(e) => {
                      ...
                      fetch(
                        fetchurl.replace(
                          "skip=0",
                          `skip=${drafts ? draftskip + limitNum : skip + limitNum}`,
                        ),
                      )
                        .then((res) => res.json())
                        .then((d) => {
                          drafts ? (draftskip += limitNum) : (skip += limitNum);
                          document.getElementById(pinwheel).style.display =
                            "none";
      ...
      if (proposals_by_event[eventCode]) {
        setTimeout(() => {
          fetch(`/assets/plans/${eventCode}.json`)
            .then((res) => res.json())
            .then((sample) => {
              render(
                plansSection(
    ...
    let drafturl =
      eventurl +
      (window.location.hostname === "localhost" ? "" : "&type=draft");
    fetch(drafturl.replace(`limit=${limitNum + 1}`, "limit=1"))
      .then((res) => res.json())
      .then((p) => showPlans(p, true));
  } else {
    const target = document.getElementById("districting-options");
...
const plansSection = (plans, eventCode, isProfessionalSamples) =>
  plans.map(
    ({ title, plans, desc }) => html`
      <section
        id="${isProfessionalSamples ? "sample" : "shared"}"
        class="place__section"
      >
        <h2>${title}</h2>
        ${isProfessionalSamples || !proposals_by_event[eventCode]
          ? html`<p>
              ${["saccounty", "saccountymap", "city_of_napa"].includes(
                eventCode,
              ) || !plans.length
                ...
                : eventCode == "pmc-districts"
                  ? html`Click on any of the maps below to open it in Districtr.
                      If you edit one of these plans, and save it with the tag
                      "pmc", it will be added to the gallery
                      <a href="/event/pmc" target="_blank">here</a>.
                      <b
                        >These sample plans were generated randomly, using
                        various combinations of the PMC’s criteria. They are
                        intended for use as starting points for exploration. You
                        can read more about their properties in
                        <a
                          href="https://www.dropbox.com/s/udenpl7zns12b22/Wisconsin.pdf?dl=0"
                          target="_blank"
                          >this summary</a
        ...
        <ul class="plan-thumbs">
          ${plans.map((p, i) =>
            loadablePlan(
              p,
              eventCode == "pmc-districts" ? "pmc" : eventCode,
              isProfessionalSamples,
            ),
          )}
        </ul>
      </section>
...
const loadablePlan = (plan, eventCode, isProfessionalSamples) => {
  let completness = null,
    ...
    districtOff =
      !coi_events.includes(eventCode) &&
      !hybrid_events.includes(eventCode) &&
      districtCount < districtGoal,
    unitOff =
      !coi_events.includes(eventCode) &&
      !hybrid_events.includes(eventCode) &&
      unitCounts[eventCode] &&
      unitCount < unitCounts[eventCode];
  ...
  return html` <a href="/edit/${plan.simple_id || plan._id}?event=${urlcode}">
    <li class="plan-thumbs__thumb">
      ...
      <figcaption class="thumb__caption">
        <h6 class="thumb__heading">
          ${plan.planName || ""}
          <br />
          ID: ${plan.simple_id || plan._id}
        </h6>
        <br />
        ${plan.isScratch
          ? html`<h4 style="font-style: italic">Draft Plan</h4>`
          : ""}
        <span>
...
function toStateCommunities(s, eventCode) {
  ...
  listPlaces(null, s.properties.NAME).then((items) => {
    let placesList = items
      .filter((place) => !place.limit || show_just_communities)
